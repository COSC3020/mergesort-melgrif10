function mergesort(array) {
    ...
    var leftSide;   //Keeps trakc of the begining of the left subarray
...
function merge(array, leftSide, middle, rightEnd){      //Merge Function
    ...
    if(array[middle]<=array[rightSide]){    //Checks if the last element of the left subarray is <= the first element in the right array
        return;     //If so the array is already sorted
    }
